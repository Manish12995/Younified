...
type ComplexityRoot struct {
	Mutation struct {
		SendMail func(childComplexity int, input model.SendMail) int
	}
...
type MutationResolver interface {
	SendMail(ctx context.Context, input model.SendMail) (string, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.sendMail":
		...
		return e.complexity.Mutation.SendMail(childComplexity, args["input"].(model.SendMail)), true
...
var sources = []*ast.Source{
	{Name: "../../../../contracts/communication/graph/mail.graphql", Input: `
input SendMailInput {
    email: String!
    subject: String!
    content: String!
...
type Mutation{
    sendMail (input: SendMailInput!): String!
}`, BuiltIn: false},
...
func (ec *executionContext) field_Mutation_sendMail_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	arg0, err := ec.field_Mutation_sendMail_argsInput(ctx, rawArgs)
	if err != nil {
		return nil, err
	}
	args["input"] = arg0
...
func (ec *executionContext) field_Mutation_sendMail_argsInput(
	ctx context.Context,
	rawArgs map[string]interface{},
) (model.SendMail, error) {
	// We won't call the directive if the argument is null.
	// Set call_argument_directives_with_null to true to call directives
	// even if the argument is null.
	_, ok := rawArgs["input"]
	if !ok {
		var zeroVal model.SendMail
		return zeroVal, nil
	}

	ctx = graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalNSendMailInput2younifiedᚑbackendᚋcontractsᚋcommunicationᚋmodelᚐSendMail(ctx, tmp)
	}
...
func (ec *executionContext) _Mutation_sendMail(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		return ec.resolvers.Mutation().SendMail(rctx, fc.Args["input"].(model.SendMail))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) unmarshalInputSendMailInput(ctx context.Context, obj interface{}) (model.SendMail, error) {
	var it model.SendMail
	asMap := map[string]interface{}{}
	for k, v := range obj.(map[string]interface{}) {
		asMap[k] = v
	}

	fieldsInOrder := [...]string{"email", "subject", "content", "category"}
...
func (ec *executionContext) unmarshalNSendMailInput2younifiedᚑbackendᚋcontractsᚋcommunicationᚋmodelᚐSendMail(ctx context.Context, v interface{}) (model.SendMail, error) {
